...
Order:
bash_pulser_calibration.sh -> pulser_calibration_v1.C -> califa_calibParFinder_v3.C -> R3BCalifaMapped2CrystalCalPar.cxx -> ...
...
5) make bash script exevutable: chmod +x bash_pulser_calibration.sh
